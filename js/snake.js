...
body.appendChild(createDiv('main-container', [
    createDiv('corner', [
      createDiv('lower', []),
      createDiv('higer', [
    ...
    createDiv('center', [
        createDiv('lower', [
          createText('high-text', 'Змейка от Влада')
        ]),
        createDiv('higer', []),
        createDiv('lower', []),
    ]),
...
document.querySelector('.center').querySelector('.higer').appendChild(game.view);
...
loader.add({name:"catImg", url:"img/cat-pass.gif"})
.load(setup);
